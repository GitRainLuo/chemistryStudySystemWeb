    ...
    <div class="exam" v-cloak>
        ...
        <div class="examContainer" :class="{'no-click':isPermitClick}">
          ...
          <div class="questionTitle">
            <p>一.单选题(每题{{scoreConfig.singleScore}}分,共计{{singleQuestionList.questionList.length*scoreConfig.singleScore}}分)</p>
          </div>
          <!--单选-->
          ...
          <div class="questionTitle">
            <p>二.多选题(每题{{scoreConfig.multiScore}}分,共计{{multiQuestionList.questionList.length*scoreConfig.multiScore}}分,选不全得一半)</p>
          </div>
          <!--多选-->

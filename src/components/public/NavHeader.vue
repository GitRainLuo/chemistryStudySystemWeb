      ...
      <div class="container">
        <div class="nav">
          <ul class="navContainer">
            <li><router-link to="/elementsPeriodicTable">周期表</router-link></li>
            <!--直接用a标签 router-link默认渲染成正确的a标签-->
            <!--<li><a href="#/elementsPeriodicTable">元素周期表</a></li>-->
            <li><router-link to="/homePage">方程式</router-link></li>
